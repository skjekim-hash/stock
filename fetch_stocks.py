...
MACRO_SENS = {
    "000660": {"skhy": 0.30, "sox": 0.30, "mu": 0.20, "nvda": 0.10, "tsmc": 0.10},   # 하이닉스: 자사 ADR이 최우선 선행
    "005930": {"smsn": 0.25, "sox": 0.30, "mu": 0.15, "nvda": 0.10, "tsmc": 0.10},   # 삼성전자: 런던 GDR 추가
    "009150": {"murata": 0.20, "sox": 0.20, "nvda": 0.10},                            # 삼성전기: 무라타(MLCC) 추가
    "066570": {"fx": 0.2, "whr": 0.15, "copper": 0.10, "nasdaq": 0.10},               # LG전자: 월풀·구리 추가
    "005380": {"fx": 0.3, "tm": 0.15, "oil": -0.10},                                  # 현대차: 토요타 동행, 유가↑ 부담
...
def fetch_market_signal():
    ...
    targets = [
        ...
        ("NVDA",  "엔비디아",          "nvda"),
        ("MU",    "마이크론",          "mu"),
        # ── 보조 시장지표 — 감응 계수 있는 지표는 MACRO_SENS 통해 종목 점수 반영 ──
        ...
        ("SMSN.IL","삼성전자 GDR",     "smsn"),   # 런던 상장분 — 삼성전자의 해외 밤흐름
        ("6981.T","무라타",            "murata"), # 삼성전기: MLCC 직접 경쟁사 (도쿄)
